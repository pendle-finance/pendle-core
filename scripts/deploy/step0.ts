...
export async function step0(
  ...
  await deployWithName(
    ...
    [
      ...
      [
        consts.misc.INVESTOR_AMOUNT.div(4).add(
          consts.misc.ADVISOR_AMOUNT.div(4)
        ),
        consts.misc.INVESTOR_AMOUNT.div(4).add(
          consts.misc.ADVISOR_AMOUNT.div(4)
        ),
        ...
        consts.misc.INVESTOR_AMOUNT.div(4)
          .add(consts.misc.ADVISOR_AMOUNT.div(4))
          .add(consts.misc.TEAM_AMOUNT.div(2)),
