...
describe("PendleCompoundMarket", async () => {
  ...
  before(async () => {
    ...
    pendleOwnershipToken = fixture.cForge.pendleOwnershipToken;
    pendleXyt = fixture.cForge.pendleFutureYieldCToken;
  ...
  it("should be able to getMarketRateExactOut", async () => {
    ...
    expect(result[1].toNumber()).to.be.approximately(11111261, 100);
  });
  ...
  it("should be able to getMarketRateExactIn", async () => {
    ...
    expect(result[1].toNumber()).to.be.approximately(9091022, 100);
  });
