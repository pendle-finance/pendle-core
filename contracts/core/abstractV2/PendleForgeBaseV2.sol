...
abstract contract PendleForgeBaseV2 is IPendleForge, WithdrawableV2, ReentrancyGuard {
    ...
    */
    function redeemAfterExpiry(
        ...
        redeemedAmount = _safeTransfer(_underlyingAsset, _expiry, _user, redeemedAmount);
    ...
    */
    function redeemDueInterests(
        ...
        amountOut = _safeTransfer(_underlyingAsset, _expiry, _user, amountOut);
    }
    ...
    */
        ...
        onlyGovernance
    {
        ...
        _totalFee = _safeTransfer(_underlyingAsset, _expiry, treasuryAddress, _totalFee);
