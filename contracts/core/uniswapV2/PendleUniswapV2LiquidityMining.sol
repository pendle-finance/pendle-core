...
contract PendleUniswapV2LiquidityMining is PendleLiquidityMiningBase {
    ...
    /**
    * Very similar to the function in PendleUniswapV2Market. Any major differences are likely to be bugs
