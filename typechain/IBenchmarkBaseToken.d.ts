...
interface IBenchmarkBaseTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IBenchmarkBaseToken extends Contract {
  ...
  interface: IBenchmarkBaseTokenInterface;
