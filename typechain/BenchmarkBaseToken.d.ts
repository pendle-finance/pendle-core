...
interface BenchmarkBaseTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class BenchmarkBaseToken extends Contract {
  ...
  interface: BenchmarkBaseTokenInterface;
