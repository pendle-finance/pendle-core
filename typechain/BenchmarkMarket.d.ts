...
interface BenchmarkMarketInterface extends ethers.utils.Interface {
  functions: {
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "bootstrap(uint256,uint256)": FunctionFragment;
    ...
    "globalIncomeIndex()": FunctionFragment;
    ...
    "lastGlobalIncomeIndex(address)": FunctionFragment;
    "lastUnderlyingYieldTokenBalance()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "globalIncomeIndex",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "lastGlobalIncomeIndex",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "lastUnderlyingYieldTokenBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class BenchmarkMarket extends Contract {
  ...
  interface: BenchmarkMarketInterface;
  ...
  functions: {
    ...
    globalIncomeIndex(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    globalIncomeIndex(overrides?: CallOverrides): Promise<PopulatedTransaction>;
