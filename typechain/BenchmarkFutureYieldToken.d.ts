...
interface BenchmarkFutureYieldTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lastNormalisedIncome(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "ot", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "ot", data: BytesLike): Result;
...
export class BenchmarkFutureYieldToken extends Contract {
  ...
  interface: BenchmarkFutureYieldTokenInterface;
  ...
  functions: {
    ...
    ot(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    ot(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ot(overrides?: CallOverrides): Promise<PopulatedTransaction>;
