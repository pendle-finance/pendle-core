...
interface IBenchmarkYieldTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IBenchmarkYieldToken extends Contract {
  ...
  interface: IBenchmarkYieldTokenInterface;
